...
if(isset($_POST['atualiza'])){
    ...
    $sql = "UPDATE Client SET name='$name', email='$email', mensagem='$msg' WHERE id=$idatualiza";
...
<form method="post">
    <label>name:</label>
    <input type="text" name="name" value="<?php echo htmlspecialchars($recado_editar['name']); ?>"/><br/>
    <label>Email:</label>
